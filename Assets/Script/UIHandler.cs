...
public class UIHandler : MonoBehaviour
{
    ...
    public void OnClickHomeButton() //Should be placed on Home button in bottombar
    {
    ...
    public void OnClickSettingsBottom() //Should be placed on Inventory button in bottombar
    {
